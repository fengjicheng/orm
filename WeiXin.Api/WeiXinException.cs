...
namespace Qhyhgf.WeiXin.Qy.Api
{
    ...
    internal  class ErrcodeConvert
    {
        ...
        public  ErrcodeConvert()
        {
            ...
            msg.Add(-1, "系统繁忙");
            msg.Add(0, "请求成功");
            msg.Add(40001, "获取access_token时Secret错误，或者access_token无效");
            msg.Add(40002, "不合法的凭证类型");
            msg.Add(40003, "不合法的UserID");
            ...
            msg.Add(40057, "不合法的callbackurl或者callbackurl验证失败");
            ...
            msg.Add(40070, "列表中所有标签（成员）ID都不合法");
            ...
            msg.Add(45002, "消息内容大小超过限制");
            msg.Add(45003, "标题大小超过限制");
            msg.Add(45004, "描述大小超过限制");
            msg.Add(45005, "链接长度超过限制");
            msg.Add(45006, "图片链接长度超过限制");
            msg.Add(45007, "语音播放时间超过限制");
            msg.Add(45008, "图文消息的文章数量不能超过8条");
            ...
            msg.Add(72015, "没有操作发票的权限");
            msg.Add(72017, "发票抬头不一致");
            msg.Add(72023, "发票已被其他公众号锁定");
            msg.Add(72024, "发票状态错误");
            msg.Add(80001, "可信域名不匹配，或者可信域名没有IPC备案（后续将不能在该域名下正常使用jssdk）");
            msg.Add(81001, "部门下的结点数超过限制（3W）");
            ...
            msg.Add(86314, "客服不唯一，发送人或接收人类型，必须只有一个为kf");
            ...
            msg.Add(301001, "应用id已存在");
            msg.Add(301002, "accesstoken不允许操作其它应用。");
            msg.Add(301004, "不允许删除超级管理员");
            msg.Add(301005, "消息型应用不允许做此操作");
            msg.Add(301006, "不允许禁用超级管理员");
            msg.Add(301008, "主页型应用不允许做此操作");
            msg.Add(301009, "应用发送消息没有接收主体");
            msg.Add(301010, "部门名已存在");
            msg.Add(301012, "职位信息不合法");
            msg.Add(301013, "座机不合法");
            msg.Add(301014, "英文名称不合法");
            msg.Add(301021, "userid错误");
            msg.Add(301022, "获取打卡数据失败");
            msg.Add(301023, "useridlist非法或超过限额");
            msg.Add(301024, "获取打卡记录时间间隔超限");
            msg.Add(302001, "批量同步成员存在userid为空的用户");
            msg.Add(302002, "管理员userid不存在");
            msg.Add(302003, "存在重复的userid");
            msg.Add(302004, "组织架构不合法");
            #endregion
        }
        /// <summary>
        /// 索引
